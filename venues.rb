Class Venues
def initialize (address, city, wheelchair_accessible,capacity)
  @address = address
  @city = city
...
Find the possible venues that are wheelchair accessible, in Toronto, and can fit at least 150 people. These results sho
